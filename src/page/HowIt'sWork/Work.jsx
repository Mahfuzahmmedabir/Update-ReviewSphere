  ...
  return (
    <section className="py-12 bg-gray-100">
      ...
      <div className="flex flex-wrap justify-center gap-8 px-4">
        {/* Step 1 */}
        <div className="flex flex-col items-center w-80 p-6 bg-white rounded-2xl shadow-lg" data-aos="fade-right">
        ...
        {/* Step 2 */}
        <div className="flex flex-col items-center w-80 p-6 bg-white rounded-2xl shadow-lg" data-aos="fade-up">
        ...
        {/* Step 3 */}
        <div className="flex flex-col items-center w-80 p-6 bg-white rounded-2xl shadow-lg" data-aos="fade-left">
